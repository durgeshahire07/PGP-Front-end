...
const emailUpdate = ({navigation}) => {
    ...
    async function handleSubmit() {
        if(data.password==''||email.update.userEmailId==''){
    ...
    return(
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center' }}>
            ...
            <View>
                ...
                >Enter your new email id and your password to update your email id</Text>
            </View>
