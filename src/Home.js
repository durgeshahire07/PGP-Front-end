  ...
  if (surveyList.isLoading) {
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          <Image
            ...
            source={require("../assets/gif/new.gif")}
          />
        </View>
      </View>
    );
    ...
    const alertCard = () => {
      if (surveyList.data.surveys.length) {
        return (
          <Animatable.View animation="pulse" style={styles.alertCard}>
            <TouchableOpacity
              onPress={() =>
                navigation.push("Daily", {
                  type: surveyList.data.surveys[0].surveyType,
                })
              }
            ...
            >
              ...
              <View style={{ paddingEnd: 55 }}>
                ...
                >
                  Tap to get your {surveyList.data.surveys[0].surveyType} survey
                  done.
                </Text>
              </View>
            </TouchableOpacity>
        ...
        return (
            ...
            //   yAxisSuffix="k"
              ...
              chartConfig={{
                ...
                backgroundGradientFrom: '#5200cc',
                backgroundGradientTo: '#c299ff',
          ...
          <>
            ...
            //   yAxisLabel={'Rs'}
              ...
              chartConfig={{
                ...
                decimalPlaces: 2,
                color: (opacity = 1) => `rgba(0, 77, 230, ${opacity})`,
                labelColor: (opacity = 1) => `rgba(71, 0, 179, ${opacity})`,
                style: {
                  borderRadius: 16,
                },
              }}
        ...
        return (
          <>
            ...
            <ProgressChart
              ...
              chartConfig={{
                backgroundColor: '#1cc910',
                backgroundGradientFrom: '#b3d9ff',
                backgroundGradientTo: '#b3d9ff',
                decimalPlaces: 2,
                color: (opacity = 1) => `rgba(204, 0, 68, ${opacity})`,
                labelColor: (opacity = 1) => `rgba(71, 0, 179, ${opacity})`,
                style: {
                  borderRadius: 16,
                },
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          <View style={styles.footer}>{surveyUpdate}</View>
...
const ProfileScreen = ({ navigation }) => {
  ...
  const UpdateHandler = () => {
    setLoading(true);
    if (
      data.lastName == user.userData.lastName &&
      data.firstName == user.userData.firstName
    ) {
      setLoading(false);
      setButton(false);
      ToastAndroid.show("No change!", ToastAndroid.SHORT);
    } else {
      updateInfo();
    }
  };
        ...
        if (modalInput.pass.length > 5) {
          ...
          try {
            ...
            if (error.response.status === 404) {
              ...
              ToastAndroid.show(
                "Email id is already in use. Use different email address",
                ToastAndroid.LONG
              );
            } else {
              ToastAndroid.show(
      ...
      if (modalInput.pass && modalInput.newPass && modalInput.confirmPass) {
        if (modalInput.newPass === modalInput.confirmPass) {
          if (modalInput.newPass.length > 5) {
            ...
            ToastAndroid.show(
              "Passwords length must be 6 characters long!",
              ToastAndroid.SHORT
            );
          }
        } else {
            ...
            >
              ...
              <View style={{ marginTop: 10 }}>
                {screenName == "EmailChange" ? (
                  <Text style={styles.textInputTitle}>
                    Enter your new email id and your password to change your
                    email id
                  </Text>
                ) : (
                  <Text style={styles.textInputTitle}>
                    Enter your old password and new password to change your
                    password
                  </Text>
                )}
              </View>
                  ...
                  <View style={{ width: "90%" }}>
                    {screenName == "EmailChange" ? (
                      <TextInput
                        ...
                        secureTextEntry={
                          secureEntry.secureTextEntry ? true : false
                        }
                  ...
                  >
                    <TouchableOpacity onPress={updateSecureTextEntry}>
                      {secureEntry.secureTextEntry ? (
                        <Feather name="eye-off" color="#a6a6a6" size={17} />
                      ) : (
                        <Feather name="eye" color="#4700b3" size={17} />
                      )}
                    </TouchableOpacity>
                  </View>
                </View>
              ...
              {screenName == "EmailChange" ? null : (
                <View>
                  <View style={{ marginTop: 10 }}>
                    ...
                    >
                      <View style={{ width: "90%" }}>
                        <TextInput
                          ...
                          secureTextEntry={
                            secureEntry.newPass_secureTextEntry ? true : false
                          }
                    ...
                    <View>
                      <Text
                        style={{ color: "grey", fontFamily: "nunito-semi" }}
                      >
                    ...
                    >
                      <View style={{ width: "90%" }}>
                        <TextInput
                          ...
                          secureTextEntry={
                            secureEntry.confirm_secureTextEntry ? true : false
                          }
              ...
              >
                <TouchableOpacity onPress={handleBack}>
                  <Text style={{ color: "#4700b3", fontFamily: "nunito-bold" }}>
                    Back
                  </Text>
                </TouchableOpacity>
              </View>
        ...
        {screen == "EmailChange" || screen == "PassChange" ? (
          ...
          <View style={{ flex: 1, paddingHorizontal: 20 }}>
            ...
            <View style={{ marginTop: 10 }}>
              ...
              <View style={[styles.inputContainer, { flexDirection: "row" }]}>
                ...
                <View style={{ marginLeft: "auto", justifyContent: "center" }}>
                  <TouchableOpacity onPress={() => setScreen("EmailChange")}>
                    <Text
                      style={{ fontFamily: "nunito-semi", color: "#4700b3" }}
                    >
                      Change
                    </Text>
                  </TouchableOpacity>
            ...
            <View style={{ marginTop: 10 }}>
              ...
              <View style={[styles.inputContainer, { flexDirection: "row" }]}>
                <TextInput editable={false} value="●●●●●●●●" />

                <View style={{ marginLeft: "auto", justifyContent: "center" }}>
                  <TouchableOpacity onPress={() => setScreen("PassChange")}>
                    <Text
                      style={{ fontFamily: "nunito-semi", color: "#4700b3" }}
                    >
                      Change
